...
const Section2 = () => {
  return (
    <section className=' flex justify-between'>
        ...
        <div  className='flex mx-auto p-20 items-center justify-center bg-[#f2fef7]  flex-1'>
            <div className='w-3/4'>
        ...
        <div  className='flex mx-auto p-20 items-center justify-center bg-[#fff9f1] flex-1'>
            <div className='w-3/4'>
